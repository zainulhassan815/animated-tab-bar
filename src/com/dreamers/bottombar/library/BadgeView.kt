...
class BadgeView @JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val newWidth = max(textWidth.toInt() + horizontalPadding, 16.dpPx) + paddingLeft + paddingRight
    ...
    override fun setEnabled(enabled: Boolean) {
        ...
        animator?.addListener(object : Animator.AnimatorListener {
            override fun onAnimationEnd(animation: Animator?, reverse: Boolean) {
                if (!isEnabled) {
                    visibility = GONE
                }
            ...
            override fun onAnimationStart(animation: Animator?, reverse: Boolean) {
                visibility = VISIBLE
            }
